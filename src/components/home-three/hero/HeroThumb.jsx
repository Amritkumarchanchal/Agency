...
function HeroThumb() {
	return (
		<div className="Svision-hero-thumb3-wrap">
			<div className="Svision-hero-thumb3">
				<LazyLoadImage src={ThumbImg} alt=" Thumb" effect="blur" />
				<div className="Svision-hero-thumb-shape2">
					<img src={ShapeMonitorImg} alt="ShapeMonitorImg" />
				</div>
				<div className="Svision-hero-thumb-shape3">
					<img src={ShapeAynaImg} alt="ShapeAynaImg" />
				</div>
			</div>
			<div className="Svision-hero-thumb-shape1">
