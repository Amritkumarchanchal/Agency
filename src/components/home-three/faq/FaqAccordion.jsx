function FaqAccordion() {
	return (
		<div className="accordion Svision-accordion-wrap4 col-12" id="Svision-accordion">
			<div className="accordion-item">
				<button className="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#one">
					What is SEO?
				</button>

				<div id="one" className="accordion-collapse collapse show" data-bs-parent="#Svision-accordion">
			...
			<div className="accordion-item">
				...
				<div id="two" className="accordion-collapse collapse" data-bs-parent="#Svision-accordion">
					<div className="accordion-body">
			...
			<div className="accordion-item">
				...
				<div id="three" className="accordion-collapse collapse" data-bs-parent="#Svision-accordion">
					<div className="accordion-body">
			...
			<div className="accordion-item">
				...
				<div id="four" className="accordion-collapse collapse" data-bs-parent="#Svision-accordion">
					<div className="accordion-body">
			...
			<div className="accordion-item">
				...
				<div id="five" className="accordion-collapse collapse" data-bs-parent="#Svision-accordion">
					<div className="accordion-body">
