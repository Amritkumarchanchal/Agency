...
function About() {
	return (
		<div className="Svision-about-section bg-orange extra-side-margin">
			<div id="Svision-counter"></div>
			<div className="container">
				<div className="row">
					<div className="col-lg-5">
						<div className="Svision-thumb" id="rotatetwo">
							<img src={ThumbImg} alt="ThumbImg" />
						</div>
					</div>
					<div className="col-lg-7">
						<div className="Svision-default-content clash-grotesk">
