...
function PortfolioCard({ portfolio: { title, description, img } }) {
	return (
		<div className="col-lg-6">
			<div className="Svision-project-thumb">
				<img src={img} alt={title} />
				<div className="Svision-project-wrap">
					<div className="Svision-project-data">
						<Link to="/single-portfolio">
							<h3>{title}</h3>
						</Link>
						<p>{description}</p>
					</div>
					<Link className="Svision-project-icon" to="/single-portfolio">
