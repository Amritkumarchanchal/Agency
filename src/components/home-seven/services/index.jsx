...
function Services() {
	return (
		<div className="section dark-bg3 Svision-section-padding5">
			<div className="container">
				<div className="Svision-section-title light bricolage-font">
					<div className="row">
						...
						<div className="col-lg-5 d-flex align-items-center justify-content-end">
							<div className="Svision-title-btn">
								<Link className="Svision-default-btn blue-btn2" to="/service">
									<span className="Svision-label-up">View All Services</span>
									<span className="Svision-label-up">View All Services</span>
								</Link>
							</div>
						</div>
